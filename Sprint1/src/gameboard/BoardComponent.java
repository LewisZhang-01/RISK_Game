...
public class BoardComponent extends JComponent{
	...
	public static Graphics2D temp_g2 ;
	public static ArrayList<Ellipse2D.Double> temp_countries ;
	
	public void getSome(Graphics2D temp_g2,ArrayList<Ellipse2D.Double> countries) {
		BoardComponent.temp_g2 = temp_g2;
		BoardComponent.temp_countries = countries;
	}
	...
	public void paintComponent(Graphics g){
		...
		getSome(g2,countries);
		
		// try use temp_g2 inside, it is working!
		/*
		temp_g2.setColor(Color.red);
		temp_g2.fill(temp_countries.get(0));
		*/
		...
		setCountry(g2, countries, 9, "DarkGreen");
		...
		setCountry(g2, countries, 10, "DarkGreen");
		...
		setCountry(g2, countries, 11, "DarkGreen");
		...
		setCountry(g2, countries, 12, "DarkGreen");
	...
	// Draw the countries
	// 0<=i<=41
	private static void setCountry(Graphics2D g2, ArrayList<Ellipse2D.Double> countries, int i, String color) {
		switch(color) {
		case "yellow":
	...
	public static void playerTerritories_Initialization() {
		...
		// try use g2 here(outside) to change color. NOT working!
		temp_g2.setColor(Color.red);
		temp_g2.fill(temp_countries.get(0));
		
		IO.resultArea.append("got here" + "\n");// test if it can reach here.
		
		// assign no.0 territorie to player 1 with red color. NOT working!
		setCountry(temp_g2, temp_countries, 0, "red");
