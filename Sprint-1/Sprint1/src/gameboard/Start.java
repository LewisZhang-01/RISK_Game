...
public class Start {
	...
	public static void main(String[] args) {
		// get the start time of the algorithms
...
//End
		...
		// get the end time of the algorithms
		/*long endTime = System.currentTimeMillis();
		long timeLong = endTime - startTime;
		// change the type of value from Long to Double, unit is ms.
		double timeDouble = Double.parseDouble(Long.toString(timeLong));
		System.out.println("elapsed time = " + timeDouble + "ms = " + timeDouble / (double) 1000 + "s");*/
	}
